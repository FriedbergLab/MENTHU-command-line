...
### WINDOWS CMD VERSION ####
### USE menthu.R on UNIX SYSTEMS ####
###############################

#### Usage ####
# Rscript menthu-cmd.R [CRISPR Option] ["PAM Sequence] [Distance to DSB] [Overhang] [TALEN Option] [TALEN scheme] [Gen Input Type] [Gen Input] [Score Threshold] [T7 opt] [verbose] [validate]
